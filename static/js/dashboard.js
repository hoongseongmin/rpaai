...
document.getElementById('task_customer').addEventListener('change', function() {
    ...
    if (monthInput) monthInput.value = `${targetDate.getFullYear()}년 ${String(targetDate.getMonth() + 1).padStart(2, '0')}월`;
    if (dateInput) dateInput.value = `${today.getFullYear()}년 ${String(today.getMonth() + 1).padStart(2, '0')}월 ${String(today.getDate()).padStart(2, '0')}일`;
